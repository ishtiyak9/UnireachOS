    ...
    head: {
      ...
      meta: [
        ...
        { name: "viewport", content: "width=device-width, initial-scale=1" },
        {
          name: "description",
          content:
            "Unireach serves as your link to a brighter future. Expert guidance for student admission, business migration, and job immigration services.",
        },
        {
          name: "keywords",
          content:
