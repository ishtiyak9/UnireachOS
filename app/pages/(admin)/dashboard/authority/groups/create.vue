...
useHead({
  title: "Create Cluster | UniReach OS",
});
...
const saveGroup = async () => {
  ...
  try {
    ...
    toast.add({
      severity: "success",
      summary: "Successful",
      detail: "Permission Cluster Initialized",
      life: 3000,
    });
    ...
    toast.add({
      severity: "error",
      summary: "Error",
      detail: error.data?.message || error.message || "Initialization failed",
      life: 3000,
    });
  } finally {
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-surface-500 font-medium">
          Define a new security node and attach authority protocols.
        </p>
      </div>
          ...
          <div class="space-y-5">
            ...
            <div class="field">
              ...
              <InputText
                ...
                class="w-full bg-surface-900 border-white/10 rounded-xl font-mono text-xs py-2.5"
