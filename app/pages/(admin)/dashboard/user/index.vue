...
const stats = computed(() => {
  ...
  const agents =
    users.value?.filter((u: any) => u.roleCategory === "AGENT").length || 0;
  ...
  <div class="p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      >
        ...
        >
          <i :class="[stat.icon, stat.color, 'text-lg']" />
        </div>
        <div>
          <p
            class="text-[10px] uppercase font-black tracking-widest text-surface-400 mb-0.5"
          >
            {{ stat.label }}
          </p>
